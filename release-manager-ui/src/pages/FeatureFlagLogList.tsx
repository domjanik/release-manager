...
import {
  ...
  selectors,
  setFilters,
} from "../store/featureFlagLogSlice";
...
const columns: Column[] = [
  ...
  { id: "changedBy", label: "Changed By", minWidth: 170, align: "center" },
];
...
export function FeatureFlagLogList(): JSX.Element {
  ...
  const rows: FeatureFlagLog[] = useSelector(
    selectors.getFilteredFeatureFlagLogs
  );
